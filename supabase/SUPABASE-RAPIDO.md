...
## Si ya instalaste Supabase antes de la versión de permisos personalizados

Ejecuta una sola vez:

`ACTUALIZAR-QATA-PERMISOS-POR-USUARIO.sql`

No vuelvas a ejecutar el instalador completo sobre tu proyecto actual solo para aplicar este cambio.

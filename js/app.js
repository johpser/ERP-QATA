...
async function guardarOrden() {
    ...
    try {
        // La OC conserva exactamente su flujo original y su correlativo contadorOC.
        const nroOC = await runTransaction(db, async (t) => {
            const ref = doc(db, "config", "contadorOC");
        ...
        const data = {
            ...
            proveedor: {
                ...
                // En Firestore el campo sigue llamándose pago. En UI/PDF se muestra FORMA DE PAGO.
